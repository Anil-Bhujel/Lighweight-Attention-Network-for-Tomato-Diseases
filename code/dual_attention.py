...
tf.config.experimental_run_functions_eagerly(True)# Added to fix the error
...
class PAM(Layer):
    ...
    # Added to fix the error https://stackoverflow.com/questions/58678836/notimplementederror-layers-with-arguments-in-init-must-override-get-conf
    def get_config(self):
